...
export function BeforeAfter() {
  ...
  return (
    <section id="before-after" className="relative py-24 overflow-hidden">
      {/* 밝은 그라데이션 배경 - 웜톤 연결 */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#f9f8f7] via-white to-stone-50" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 right-0 w-[300px] h-[300px] bg-yellow-100/15 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="container-custom relative z-10">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                activeCase === index
                  ...
                  : "bg-white/80 text-slate-600 border border-slate-200 hover:border-amber-300 hover:text-amber-600"
              }`}
            >
              {item.label}
            </button>
        ...
        >
          {/* 크리스탈 프레임 */}
          <div className="relative p-2 rounded-3xl bg-gradient-to-br from-white via-amber-50/30 to-stone-50 border border-amber-200/50 shadow-xl shadow-amber-100/30">
            {/* 코너 장식 */}
            <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-amber-400/60 rounded-tl-3xl z-20" />
            <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-amber-400/60 rounded-tr-3xl z-20" />
            <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-amber-400/60 rounded-bl-3xl z-20" />
            <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-amber-400/60 rounded-br-3xl z-20" />
            ...
            <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-slate-100">
              ...
              {/* 슬라이더 라인 */}
              <div
                className="absolute top-0 bottom-0 w-1 bg-gradient-to-b from-amber-400 via-yellow-500 to-amber-400 shadow-lg shadow-amber-400/50 z-10"
                style={{ left: `${sliderPosition}%`, transform: "translateX(-50%)" }}
              >
                {/* 슬라이더 핸들 */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center shadow-lg shadow-amber-400/40 cursor-grab border-2 border-white">
              ...
              {/* 레벨 라벨 */}
              <div className="absolute top-4 left-4 px-3 py-1.5 bg-white/90 backdrop-blur-sm text-amber-700 text-sm font-medium rounded-full border border-amber-200 shadow-sm z-10">
                {currentCase.label}
              </div>
              ...
              <div className="absolute bottom-4 right-4 bg-gradient-to-r from-amber-500 to-yellow-500 text-white px-4 py-1.5 rounded-full text-sm font-medium shadow-lg shadow-amber-400/30 z-10">
                AFTER
              </div>
              ...
              {currentCase.pairs.map((_, index) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all duration-300 ${
                    activePair === index
                      ? "bg-gradient-to-r from-amber-500 to-yellow-500 w-6"
