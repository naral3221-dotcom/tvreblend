  ...
  return (
    <section id="benefits" className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/3 w-[450px] h-[450px] bg-amber-100/30 rounded-full blur-[120px]" />
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="font-handwriting text-xl md:text-2xl mb-4">
            <span className="text-stone-500">투명브이리프팅만의</span>{" "}
            <span className="text-amber-600">특별함</span>
          </p>

          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-stone-800">
            {headline.text}{" "}
            <span className="bg-linear-to-r from-amber-500 via-yellow-500 to-orange-500 bg-clip-text text-transparent">
              {headline.highlight}
            </span>
            인가요?
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-8 rounded-2xl bg-white/80 border border-stone-200 backdrop-blur-sm shadow-sm hover:border-amber-200 hover:shadow-lg hover:shadow-amber-100/30 transition-all duration-500 relative overflow-hidden">
                {/* 호버 글로우 */}
                ...
                <div className="relative z-10 flex items-start gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-amber-100 to-orange-100 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-300">
