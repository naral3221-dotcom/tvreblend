...
export const levelSystemContent: LevelSystemContent = {
  ...
  subheadline: "당신의 얼굴에 맞는 레벨을 찾으세요",
  question: [
    "\"몇 번 당기는 리프팅인가요?\"",
  ...
  levels: [
    ...
    },
    {
      ...
      available: true, // 활성화
      steps: [
        { step: 1, name: "STEP 1", shapeKey: "level 3_1", description: "라인정리 + 골격 보강" },
        { step: 2, name: "STEP 2", shapeKey: "level 3_2", description: "이중 견인 (Deep Lifting)" },
        { step: 3, name: "STEP 3", shapeKey: "level 3_3", description: "밀도 강화 (Density Lock)" },
      ],
    },
  ],
};
